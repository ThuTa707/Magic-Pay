...
@section('content')
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <a href="{{ route('admin.admin-users.create') }}" class="btn btn-primary mt-2 ml-3"><i
                    class="fa fa-plus-circle" aria-hidden="true"></i> Create Admin User</a>
    ...
    <script>
        $(function() {
            $('#tableTest').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "/admin/datatable/", // Pls write carefully your route 
